...
// Both years set and different -> render as a range.
...
assert text.contains('Copyright 2013-2026 Test Organization') : \
    "Expected 'Copyright 2013-2026 Test Organization' but got:\n${text}"
