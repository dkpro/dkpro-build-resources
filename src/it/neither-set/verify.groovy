...
// Neither year available -> still render a well-formed line naming the organization.
...
assert text.contains('Copyright Test Organization') : \
    "Expected 'Copyright Test Organization' but got:\n${text}"
